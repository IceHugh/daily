...
**0xfig** 是一个基于 [VitePress](https://vitepress.dev/) 构建的科技资讯平台，专注于 **Web3**、**AI** 和**超级个体**（OPC）领域的前沿资讯分享与深度洞察。

## 🎯 平台定位

- **Web3 前沿**: 区块链、DeFi、NFT、DAO 等去中心化技术的最新动态
- **AI 创新**: 人工智能、机器学习、大模型的技术突破与产业应用
- **超级个体**: 一人公司、独立开发、数字游民的生活方式与价值探索
